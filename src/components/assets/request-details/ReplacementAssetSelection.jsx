function ReplacementAssetSelection({
  assetTypeName,
  availableAssets,
  selectedAsset,
  onSelectAsset,
    ...
    <div className="rounded-[16px] border border-[#e5e7eb] bg-[#f9fafb] p-5">
      <div>
        ...
        <p className="mt-1 text-[13px] font-medium text-[#6b7280]">
          Select an available {assetTypeName || 'asset'} to replace the
          employee's current asset.
        </p>
      </div>

      <div className="mt-5 space-y-3">
        {availableAssets.length === 0 && (
          <p className="rounded-[14px] border border-[#e5e7eb] bg-white px-4 py-4 text-[14px] font-medium text-[#6b7280]">
            No available replacement assets found.
          </p>
        )}
...
export default ReplacementAssetSelection
